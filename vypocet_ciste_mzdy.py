...
vyplata = float(input("Zadej svojí hrubou mzdu: "))
...
if dan == 15 and deti == 0:
    vypocet = vyplata - socko - zdravko - max(0, superhruba * 0.15 - sleva_poplatnik)
...
if dan == 23 and deti == 0:
    vypocet4 = vyplata - (socko + zdravko) - (superhruba * 0.23 - sleva_poplatnik)
    print(f"Čistá mzda je: {vypocet4} Kč")

if dan == 23 and deti == 1:
    vypocet5 = vyplata - (socko + zdravko) - (superhruba * 0.23 - sleva_poplatnik - 1267)
    print(f"Čistá mzda je: {vypocet5} Kč")

if dan == 23 and deti == 2:
    vypocet6 = vyplata - (socko + zdravko) - (superhruba * 0.23 - sleva_poplatnik - 1267 - 1860)
    print(f"Čistá mzda je: {vypocet6} Kč")

if dan == 23 and deti == 3:
    vypocet7 = vyplata - (socko + zdravko) - (superhruba * 0.23 - sleva_poplatnik - 1267 - 1860 - 2320)
    print(f"Čistá mzda je: {vypocet7} Kč")
